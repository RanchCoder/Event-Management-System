...
if (!mysqli_stmt_prepare($stmt, $query)) {
    header("Location: customer.php?error=preparestatementerror");
    exit();
} else {
    ...
    if ($resultCheck > 0) {
        header("Location: ../Web-content/customerFormatter.php?error=userAlreadySuccess");
        ...
        if (!mysqli_stmt_prepare($stmt1, $query)) {
            header("Location: ../Web-content/customerFormatter.php?error=preparestatementerror");
            exit();
        } else {
            ...
            header("Location: ../Web-content/customerFormatter.php?Success=newDataAdded");
            echo $_SESSION['userIdentity'].$_SESSION['userImageStatus'];
            exit();
        }
    }
