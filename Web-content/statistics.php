...
<?php
   if (isset($_SESSION['userIdentity'])) {
       ...
       <div class="container">
           <a href="../Web-content/Home.php" class="brand-logo">RV Events</a>
           ...
           <ul class="right hide-on-med-and-down">
               ...
               <li><a href="../Web-content/diveIn.php">Dive In</a></li>
   
   
               <li><a href="../Web-content/statistics.php">statistics</a></li>
 ...
 <ul class="sidenav" id="mobile-links">
     ...
     <li><a href="../Web-content/login.php">Login</a></li>
     <li><a href="../Web-content/SignUp1.php">SignUP</a></li>
