    ...
    <nav class="nav wrapper">
        <div class="container">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a href="../searchServiceProvider.php">Service providers</a></li>


                
                <li><a href="../myRecordsCustomer.php">Personal Records</a></li>
        ...
        <div class="side">
            ...
            <div class="text">
                ...
                <div class="collection">
                    <a href="../searchServiceProvider.php" class="collection-item">Service providers</a>


                
                    <a href="../myRecordsCustomer.php" class="collection-item">Personal Records</a>
                ...
                <div class="col s12 m6">
                    <div class="card">
                        <div class="card-image">
                            <img src="../images/profileImages/customer/<?php echo $imageName?>" style="max-height:300px;max-width:400px;">
