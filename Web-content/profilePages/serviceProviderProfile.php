<?php
  ...
  if (isset($_SESSION['userIdentity'])) {
      include('../phpCode/databaseConnector.php');
      $username = $_SESSION['userIdentity'];
      //echo 'reached'.$username;
...
<nav class="nav wrapper pink accent-4">
        <div class="container">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a href="../latestRequirement.php">requirements</a></li>


                <li><a href="../upcomingEventsService.php">Upcoming Events</a></li>
                <li><a href="../myRecordService.php">Personal Records</a></li>
...
<?php
  $sql = "SELECT * FROM companydetails where username='".$username."'";
  ...
  if (mysqli_num_rows($result) > 0) {
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        $ownername = $row['companyOwner'];
        $contact = $row['companyContact'];
        $location = $row['companyLocation'];
        $service = $row['companyService'];
        $companymessage = $row['companyMessage'];

        //echo $username1.$company;
    }
  ...
  ?>
        ...
        <div class="side">
            ...
            <div class="text">
                ...
                <div class="collection">
                    <a href="../latestRequirement.php"  class="collection-item">requirements</a>
                    <a href="../upcommingEventsService.php" class="collection-item">Upcoming Events</a>
                    <a href="../myRecordsService.php" class="collection-item">Personal Records</a>
                    <a href="../phpCode/logout.php" class="collection-item">logout</a>
                </div>
    ...
    <div class="col s12 m6">
      <div class="card">
        ...
        <img src="../images/profileImages/serviceProvider/<?php echo $imageName?>" style="max-height:300px;max-width:400px;">
         
          <a class="btn-floating halfway-fab waves-effect waves-light red"><i class="material-icons red">favorite</i></a>
           
        
        </div>
        <div class="card-content" style="text-align:center;line-height:2em;color:#ffff66">
