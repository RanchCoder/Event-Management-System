...
<body>
  ...
  <?php
    ...
    if (!mysqli_stmt_prepare($stmt, $query)) {
        header("Location: ../profilePages/jobProfile.php?error=sqlError");
        echo 'error';
        exit();
    } else {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $username1 = $row['seekerName'];
                $lastname = $row['seekerLastName'];
                $contact = $row['seekerContact'];
                $location = $row['seekerLocation'];
                $education = $row['seekerEducation'];
    ...
    <nav class="nav wrapper">
        <div class="container">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a href="../myRecords.php">Personal Records</a></li>
        ...
        <div class="side">
            ...
            <div class="text">
                ...
                <div class="collection">
                    <a href="../searchJob.php"  class="collection-item">jobs</a>
                    <a href="../upcomingEvents.php" class="collection-item">Upcoming Events</a>
                    <a href="../myRecords.php" class="collection-item">Personal Records</a>
                ...
                <div class="col s12 m6">
                    <div class="card">
                        <div class="card-image">
                            <img src="../images/profileImages/jobSeeker/<?php echo $imageName?>" style="max-height:300px;max-width:400px;">
